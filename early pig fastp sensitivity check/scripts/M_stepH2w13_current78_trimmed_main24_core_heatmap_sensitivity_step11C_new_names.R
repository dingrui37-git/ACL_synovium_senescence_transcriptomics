...
step11C_overlap_file <- find_existing_file(c(
  file.path(main_mouse_dir, "07_tables", "step11C_intersect_current_gorth_mapping_with_CellAge_clean", "step11C_persistent_CellAge_overlap_genes.csv"),
  file.path(main_mouse_dir, "07_tables", "step11C_intersect_current_gorth_mapping_with_CellAge_clean", "step11C_persistent_CellAge_overlap_genes_compact.csv")
))
